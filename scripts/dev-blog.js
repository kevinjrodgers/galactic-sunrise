...
function createJulyPost() {
    ...
    let paragraphOneText = document.createTextNode("We at Star Fiend Studio are very excited to announce the official launch of our website!");

    let paragraphTwo = document.createElement("p");
    let paragraphTwoText = document.createTextNode(`Many of our users and patreons have been excitedly asking for updates about Galactic Sunrise. 
    ...
    let paragraphThreeText = document.createTextNode(`We hope you all are just as excited about the game as we are and be please sure to subscribe to 
...
function createAugPost() {
  ...
  let paragraphOne = document.createElement("p");
  let paragraphOneText = document.createTextNode(`As many of you know, we at Star Fiend Studio are working on a turn-based rpg called Galactic Sunrise. 
                                                  We thought it would be best to formally introduce it!`);

  let paragraphTwo = document.createElement("p");
  let paragraphTwoText = document.createTextNode(`Although it is very early in the works, it will be a sci-fi rpg heavily inspired by a game called Golden 
  ...
  let paragraphThree = document.createElement("p");
  let paragraphThreeText = document.createTextNode(`We will be showcasing some of the concept art in the next update. We hope to see you then!`);
